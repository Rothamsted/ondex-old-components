...
//		p.setMinimumSize(new Dimension(1000,50));
...
//		p.setMinimumSize(new Dimension(1000,50));
	...
	public enum Field {
		ID("Id"), FULLNAME("Full name"), DESCRIPTION("Description"), 
		INVERSE("Inverse name"), SYMMETRIC("Symmetric"), ASSYMMETRIC("Asymmetric"),
		ANTISYMMETRIC("Antisymmetric"), REFLEXIVE("Reflexive"), 
		TRANSITIVE("Transitive"), SYMMETRY("Symmetry"), UNIT("Unit"), 
		DATATYPE("Data type");
